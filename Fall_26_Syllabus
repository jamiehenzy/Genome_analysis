...
Format: In-person. Each session will contain some lecture/discussion to introduce concepts, followed by lots of hands-on exercises working with various tools, as in a workshop. During the lecture portion, please keep your laptops closed.
Material: 
...
Attendance: This course is formatted as a workshop and is similar to language courses in that you'll be learning the new languages UNIX and R and using them to write scripts, requiring frequent practice and use of your new "words". Additionally, computational work involves a lot of troubleshooting which is best done in the company of others who may be facing the same annoying snags and can help work through them. Therefore, attendance is an important component of the course and counts for 20% of the grade. Beginning with our 3rd meeting, attendance is scored through completion (not correctness) of in-class quizzes/worksheets. Everyone is generously allowed three absences, no questions asked (exam day is an exception). The three absences include Wellness Days and any other personal absences, whether due to illness, accident, or bad hair. Any absence beyond the allotted, however, will result in a zero for that day.
...
Grading: 	Timely and successful completion of five modules 	50%
